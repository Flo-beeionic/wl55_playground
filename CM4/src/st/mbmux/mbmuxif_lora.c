...
/**
  ...
  */
__attribute__((section ("MB_MEM1"))) uint32_t aLoraCmdRespBuff[MAX_PARAM_OF_LORAWAN_CMD_FUNCTIONS];/*shared*/

/**
  * @brief LoRa notif buffer to exchange data between CM4 and CM0+
  */
__attribute__((section ("MB_MEM1"))) uint32_t aLoraNotifAckBuff[MAX_PARAM_OF_LORAWAN_NOTIF_FUNCTIONS];/*shared*/
